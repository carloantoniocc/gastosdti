			...
			<div class="container">
				<div class="col-md-8 ">
					<div class="panel panel-default">
						<div class="panel-heading"><h4>Importar detalle de facturación desde Excel</h4></div>
						<div class="panel-body text-left">
					        {{ csrf_field() }} 
			                    ...
			                    <form class="form-inline" role="form" method="POST" action="importarfact" accept-charset="UTF-8" enctype="multipart/form-data">	
			 						{{ csrf_field() }}
				    ...
				    <div class="col-md-4">
				        <div class="panel panel-info">
				            ...
				            <div class="panel-footer">
				                <a class="btn btn-lg btn-block btn-info" href="{{ URL::to('ufs/downloadfile', ['$file' => 'CargaUF.xlsx'] ) }}"><span class="glyphicon glyphicon-download"></span> Descargar</a>
				            </div>
				        </div>
