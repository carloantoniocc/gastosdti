        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="/providers/{{$provider->id}}">
                        ...
                        <div class="form-group{{ $errors->has('rut') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="rut" type="text" class="form-control" name="rut" value="{{$provider->rut}}" required autofocus>
